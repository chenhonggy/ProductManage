...
package com.launcher.productmanage.View.PullToRefreshView;
...
public class PullToRefreshAttacher implements View.OnTouchListener {
    ...
    public static abstract class HeaderTransformer {
         ...
         * {@link PullToRefreshAttacher.Options#headerLayout}.
         *
         ...
         * from {@link PullToRefreshAttacher.OnRefreshListener} but is more suitable for header view updates.
         */
         ...
         * called when {@link PullToRefreshAttacher.Options#refreshOnUp} is set to true.
         */
    ...
    public static final class Options {
         ...
         * {@link PullToRefreshAttacher.DefaultHeaderTransformer} will be used.
         */
